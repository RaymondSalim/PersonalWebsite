...
export class Header extends React.Component<HeaderProps, HeaderState> {
  ...
  render() {
    return (
      <header
        id={Header.elementID}
        className={`bg-theme-secondary-light dark:bg-theme-secondary-dark z-50 fixed max-w-[100vw] w-full top-0  h-header flex justify-between transition-all duration-[250ms] px-4
      ...
      >
        <Logo
          className={'text-theme-primary-light p-1 h-[calc(var(--header-height-scroll)-1rem)] w-[calc(var(--header-height-scroll)-1rem)] my-auto ml-3 z-40'}/>
        <nav
